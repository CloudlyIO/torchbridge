...
Supported Models:
- Qwen 3 (all variants, default: Qwen/Qwen3-0.6B)
- DeepSeek R1, Gemma 3, Llama 4
- Mistral-7B
- Phi-2, Phi-3

Usage:
    # Run with Qwen3-0.6B (default)
...
def main():
    ...
    parser.add_argument(
        ...
        help="Model name (e.g., Qwen/Qwen3-8B, deepseek-ai/DeepSeek-R1-Distill-Qwen-7B)"
    )
    parser.add_argument(
        "--quantization",
        type=str,
