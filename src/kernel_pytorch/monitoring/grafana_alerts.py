"""
Grafana Alert Rules for KernelPyTorch
...
class AlertRuleBuilder:
    ...
    def latency_p99_alert(
        ...
        return AlertRule(
            ...
            condition=AlertCondition(
                query="histogram_quantile(0.99, rate(kernelpytorch_inference_latency_milliseconds_bucket[5m]))",
            ...
            annotations=AlertAnnotation(
                ...
                runbook_url="https://docs.kernelpytorch.io/runbooks/high-latency",
            ),
            labels=[
                AlertLabel("service", "kernelpytorch"),
    ...
    def latency_p95_alert(
        ...
        return AlertRule(
            ...
            condition=AlertCondition(
                query="histogram_quantile(0.95, rate(kernelpytorch_inference_latency_milliseconds_bucket[5m]))",
                threshold=threshold_ms,
                operator=ComparisonOperator.GREATER_THAN,
                for_duration=for_duration,
                datasource_uid=self.datasource_uid,
    ...
    def error_rate_alert(
        ...
        return AlertRule(
            ...
            condition=AlertCondition(
                query='sum(rate(kernelpytorch_inference_requests_total{status="error"}[5m])) / '
                      'sum(rate(kernelpytorch_inference_requests_total[5m])) * 100',
            ...
            annotations=AlertAnnotation(
                ...
                runbook_url="https://docs.kernelpytorch.io/runbooks/high-error-rate",
            ),
            labels=[
                AlertLabel("service", "kernelpytorch"),
    ...
    def gpu_memory_alert(
        ...
        return AlertRule(
            ...
            condition=AlertCondition(
                query="kernelpytorch_gpu_memory_used_bytes / kernelpytorch_gpu_memory_total_bytes * 100",
                threshold=threshold_percent,
                operator=ComparisonOperator.GREATER_THAN,
                for_duration=for_duration,
                datasource_uid=self.datasource_uid,
    ...
    def gpu_memory_critical_alert(
        ...
        return AlertRule(
            ...
            annotations=AlertAnnotation(
                ...
                runbook_url="https://docs.kernelpytorch.io/runbooks/gpu-oom",
            ),
            labels=[
                AlertLabel("service", "kernelpytorch"),
                AlertLabel("type", "resource"),
    ...
    def throughput_alert(
        ...
        return AlertRule(
            name="Low Throughput",
            condition=AlertCondition(
                query="kernelpytorch_inference_throughput_samples_per_second",
    ...
    def availability_alert(
        ...
        return AlertRule(
            ...
            condition=AlertCondition(
                query='sum(rate(kernelpytorch_inference_requests_total{status="success"}[1h])) / '
                      'sum(rate(kernelpytorch_inference_requests_total[1h])) * 100',
                threshold=threshold_percent,
                operator=ComparisonOperator.LESS_THAN,
                for_duration=for_duration,
                datasource_uid=self.datasource_uid,
            ...
            annotations=AlertAnnotation(
                ...
                runbook_url="https://docs.kernelpytorch.io/runbooks/availability-slo",
            ),
            labels=[
                AlertLabel("service", "kernelpytorch"),
                AlertLabel("type", "slo"),
    ...
    def error_budget_alert(
        ...
        return AlertRule(
            ...
            condition=AlertCondition(
                query='(1 - sum(rate(kernelpytorch_inference_requests_total{status="success"}[1h])) / '
                      'sum(rate(kernelpytorch_inference_requests_total[1h]))) / (1 - 0.999) * 100',
    ...
    def no_requests_alert(
        ...
        return AlertRule(
            ...
            condition=AlertCondition(
                query="sum(rate(kernelpytorch_inference_requests_total[5m]))",
                threshold=0,
...
def create_default_alert_rules(
    ...
    latency_group = AlertRuleGroup(
        name="KernelPyTorch Latency Alerts",
        folder="KernelPyTorch",
    )
    ...
    error_group = AlertRuleGroup(
        name="KernelPyTorch Error Alerts",
        folder="KernelPyTorch",
    )
    ...
    resource_group = AlertRuleGroup(
        name="KernelPyTorch Resource Alerts",
        folder="KernelPyTorch",
    )
    ...
    traffic_group = AlertRuleGroup(
        name="KernelPyTorch Traffic Alerts",
        folder="KernelPyTorch",
    )
