"""
Grafana Dashboard Generator for KernelPyTorch

This module provides pre-configured Grafana dashboard definitions for
monitoring KernelPyTorch inference servers.
...
def create_inference_dashboard(
    ...
    dashboard = GrafanaDashboard(
        title=f"KernelPyTorch Inference - {model_name}",
        description="Inference performance monitoring for KernelPyTorch models",
        tags=["kernelpytorch", "inference", model_name],
    )
...
def create_system_dashboard(
    ...
    """
    dashboard = GrafanaDashboard(
        title="KernelPyTorch System Resources",
        description="System resource monitoring for KernelPyTorch deployments",
        tags=["kernelpytorch", "system", "gpu"],
    )
...
def create_full_dashboard(
    ...
    full_dashboard = GrafanaDashboard(
        title=f"KernelPyTorch Full Dashboard - {model_name}",
        description="Complete monitoring dashboard for KernelPyTorch inference",
        tags=["kernelpytorch", "inference", "system", model_name],
    )
