"""
Triton Inference Server Integration for KernelPyTorch

This module provides configuration generation and model repository setup
for deploying KernelPyTorch-optimized models to NVIDIA Triton Inference Server.
...
def generate_triton_model_repository(
    ...
    # Create metadata file with KernelPyTorch info
    metadata = {
        "framework": "kernel_pytorch",
        "version": "0.3.9",
    ...
    metadata_path = model_dir / "kernel_pytorch_metadata.json"
