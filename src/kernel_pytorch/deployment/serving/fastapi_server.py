"""
FastAPI Inference Server for KernelPyTorch

This module provides a lightweight REST API server for serving KernelPyTorch-
...
class InferenceServer:
    ...
    def _create_app(self) -> "FastAPI":
        ...
        app = FastAPI(
            title=f"KernelPyTorch Inference Server - {self.config.model_name}",
            description="REST API for model inference with KernelPyTorch optimizations",
