...
Examples:
  tb-optimize --model model.pt --level production --output optimized_model.pt
  tb-optimize --model resnet50 --level compile --benchmark --verbose
  tb-optimize --input-shape 1,3,224,224 --level triton --hardware auto
            """
        )
