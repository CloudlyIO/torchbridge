"""
Model export commands for TorchBridge CLI.
...
Examples:
  tb-export --model model.pt --format onnx --output model.onnx
  tb-export --model model.pt --format torchscript --method trace
  tb-export --model model.pt --format safetensors --fp16
  tb-export --model model.pt --format all --output-dir exports/
            """
        )
    ...
    def _run_export(args) -> int:
        ...
        if verbose:
            print("TorchBridge Model Export")
            print("=" * 50)
