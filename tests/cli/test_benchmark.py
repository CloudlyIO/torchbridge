...
class TestBenchmarkCommand:
    ...
    def test_load_model_resnet50(self):
        ...
        with patch.dict(
            "sys.modules",
            {"torchvision": mock_torchvision, "torchvision.models": mock_models},
        ):
    ...
    def test_apply_optimization_basic(self):
        ...
        optimized = BenchmarkCommand._apply_optimization(
            model, "basic", input_shape, device
        )
    ...
    def test_benchmark_model(self):
        ...
        result = BenchmarkCommand._benchmark_model(
            model, "test_model", input_shape, device, args
        )
