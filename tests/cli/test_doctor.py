...
class TestDiagnosticResult:
    ...
    def test_diagnostic_result_minimal(self):
        ...
        result = DiagnosticResult(
            name="Simple Check", status="warning", message="Something might be wrong"
        )
...
class TestDoctorCommand:
    ...
    def test_check_hardware_compute_capability(self, mock_props, mock_cuda_available):
        ...
        with patch("torch.cuda.get_device_name", return_value="RTX 3080"):
            ...
            compute_result = next(
                (r for r in results if r.name == "GPU Compute Capability"), None
            )
    ...
    def test_attempt_fixes(self):
        ...
        results = [
            DiagnosticResult(
                "Test", "warning", "Issue", recommendation="pip install package"
            )
        ]
    ...
    def test_save_report(self):
        ...
        results = [DiagnosticResult("Test", "pass", "OK", details="Some details")]
...
class TestDoctorCIMode:
    ...
    def test_ci_mode_json_structure(self, capsys):
        ...
        results = [
            DiagnosticResult(
                "Check", "pass", "Msg", details="Det", recommendation="Rec"
            ),
        ]
