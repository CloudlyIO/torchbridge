...
class TestOptimalFormat:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (HardwareBackend.CUDA, NVIDIAArchitecture.AMPERE, QuantizationFormat.INT8_SMOOTHQUANT),
            (HardwareBackend.CUDA, NVIDIAArchitecture.ADA, QuantizationFormat.INT8_SMOOTHQUANT),
